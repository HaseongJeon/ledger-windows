...
export const WORK_COLOR = { "전장": "#B65420", "선팅": "#35577F", "덴트": "#647680" };
export const CAT_COLOR = {
  "급여": "#A8323F", "외주비": "#C05B3E", "복리후생비": "#B65420", "통신비": "#C8863A",
  "관리비": "#B8790A", "접대비": "#97923A", "지급임차료": "#5E8C4E", "수선비": "#2F7A5C",
  "보험료": "#0B5C3E", "차량유지비": "#2A6E77", "소모품비": "#35577F", "지급수수료": "#4D5F97",
  "잡비": "#6B5F8A", "잡손실": "#8A5B78",
  "부가세": "#647680", "종합소득세": "#3D4A52"
};
